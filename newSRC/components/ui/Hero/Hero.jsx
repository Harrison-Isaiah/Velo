...
const Hero = () => (
    <section className="bg-black lg:h-full overflow-hidden">
            ...
            >
                <div>
                    <div className="space-y-5 max-w-3xl mx-auto text-center">
                        <h1 className="text-6xl bg-clip-text text-transparent bg-gradient-to-r font-medium mx-auto sm:text-4xl "
                            style={{
                        ...
                        <h1 className="text-6xl bg-clip-text text-transparent bg-gradient-to-r font-semibold mx-auto sm:text-6xl"
                            style={{
                                backgroundImage: "linear-gradient(179.1deg, #FFFFFF 0.77%, rgba(255, 255, 255, 0) 182.09%)"
                            }}
                        >
